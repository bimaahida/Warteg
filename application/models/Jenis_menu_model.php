...
class Jenis_menu_model extends CI_Model
{

    public $table = 'jenis_menu';
    public $id = 'id';
    public $order = 'DESC';
    ...
    // datatables
    function json() {
        $this->datatables->select('id,jenis');
...
/* End of file Jenis_menu_model.php */
/* Location: ./application/models/Jenis_menu_model.php */
