...
class Jenis_parameter_model extends CI_Model
{
    ...
    // datatables
    function json() {
        $this->datatables->select('id,parameter');
...
/* End of file Jenis_parameter_model.php */
/* Location: ./application/models/Jenis_parameter_model.php */
